        ...
        children: [
          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(color: const Color(0xFF2BCC71).withOpacity(0.15), shape: BoxShape.circle),
            ),
          ),
          Positioned(
            bottom: 100, left: -100,
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: const Divider(height: 24, thickness: 1, color: Color(0xFFE8F1F2)),
          ),
